      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">Sign in to RateGallery</p>
          </div>
          ...
          <button
            ...
            className="w-full bg-white hover:bg-gray-50 disabled:bg-gray-100 border-2 border-gray-300 text-gray-700 font-semibold py-2 rounded-lg transition flex items-center justify-center gap-2"
          >
            {googleLoading ? (
              <>
                <Loader className="w-4 h-4 animate-spin" />
          ...
          <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-xs text-blue-800">
              <strong>Demo Mode:</strong> Use any email with password <code className="bg-blue-100 px-1 rounded">password123</code> to test.
            </p>
          </div>
        </div>
      </div>
